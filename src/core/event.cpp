...
namespace KalaKit::Core
{
	void Event::PrintNewLine()
	{
		...
		this->PrintConsoleMessage(EventType::event_print_message, emptyData);
	}
	...
	void Event::PrintConsoleMessage(EventType eventType, const PrintData& printData)
	{
		string result{};
	...
	bool Event::SendEmail(const EmailData& emailData)
	{
